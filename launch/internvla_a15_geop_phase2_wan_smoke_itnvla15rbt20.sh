...
###############################################################################
# WAN smoke test: 1 GPU, 2 steps, action_loss_only=false
# Validates WAN video loss + 3D kpt before 0807 formal training
...
JOB_NAME="${JOB_NAME:-$(date +'%Y_%m_%d_%H_%M_%S')-${POLICY}-geop-phase2-wan-smoke-stackb3-abs}"
...
echo "WAN smoke: 1 GPU, BS=${BATCH_SIZE}, STEPS=${STEPS}"
