#!/usr/bin/env bash
# =============================================================================
# GeoP Phase2 (080719_2) resume monitor + post-run GCS upload wrapper.
# Continues training from step 10000 to 20000.
#
# Usage:
...
TRAIN_SCRIPT="${SCRIPT_DIR}/internvla_a15_geop_phase2_finetune_stackb3_080719_resume_20k.sh"
TRAIN_LOG="${TRAIN_LOG:-${PROJ_ROOT}/outputs/internvla_a1_5/train_080719_2_geop_phase2.log}"
MONITOR_LOG="${MONITOR_LOG:-${PROJ_ROOT}/outputs/internvla_a1_5/monitor_080719_2_geop_phase2.log}"
...
_log "Monitor started (080719_2 resume, POLL_SEC=${POLL_SEC}, target_steps=${STEPS})"
