...
###############################################################################
# Phase 2 fine-tune (080718): aw10, vw0.1, kw0.1, action_loss_only=false
...
export MASTER_PORT=${MASTER_PORT:-36501}
...
JOB_NAME="${JOB_NAME:-$(date +'%Y_%m_%d_%H_%M_%S')-${POLICY}-geop-phase2-aw10-vw0.1-kw0.1-stackb3-abs-10k}"
...
echo "loss_weights: action=10 video=0.1 kpt=0.1 kpt_fut=0.1"
