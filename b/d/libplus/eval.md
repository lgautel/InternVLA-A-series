...
> 对保存在 `/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model/` 中的 InternVLA-A1.5 + GeoP (3D Keypoint) checkpoint 进行 LIBERO-plus 零样本鲁棒性评估的完整实施方案.
>
...
| 项目 | 值 | 来源 |
|------|-----|------|
| **Checkpoint 路径** | `/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model/` | 用户指定 |
...
| **训练步数** | 26725 / 53450 (50%, 中间 checkpoint) | 目录名 `026725` |
...
> **训练仍在进行中** (截至 2026-09-14). 8 × H200 GPU 全部被训练任务占用 (~138 GB/卡), 进度 ~60% (step 32070/53450). **预计 2026-09-15 ~08:00 完成, 届时 GPU 释放.**
>
> 用户指定评估的 checkpoint 026725 **已保存完毕** (2026-09-13 20:20), 可安全读取.
...
|------|--------|------|---------|------------|
| `--ckpt_path` | `.../026725/pretrained_model` | Checkpoint 目录 | 用户指定 | 决定性 |
...
| **Client venv** | **不存在, 需要创建** | 需要 robosuite, mujoco, libero-plus 等 |
...
CKPT="/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model"
...
CLIENT_VENV="/B/VENV/libero_plus_client"    # 待创建
PROJ="/B/SRC/itvlaGpLibPlus"

# 评估结果存放在与训练相同的 ~/b/Ckp/ 层级下:
EVAL_DIR="/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/eval_libero_plus/step_026725"
```
...
config = PreTrainedConfig.from_pretrained(
    '/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model'
)
...
CUDA_VISIBLE_DEVICES=0 python evaluation/LIBERO/policy_server/server_policy.py \
    --ckpt_path "/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model" \
    --host "0.0.0.0" \
    --port 5784 \
    --device cuda \
    --resize_size 224 \
...
# --- 所有环境变量在一处设置 ---
export CKPT_PATH="/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/checkpoints/026725/pretrained_model"
...
# --- 输出: 存到训练目录下, 关闭视频 ---
export EVAL_LOG_DIR="/home/a26113/b/Ckp/4dwvlaOpvlaLibplusKpt0911/2026_09_12_08_52_49-internvla_a1_5-libplus-sft/eval_libero_plus/step_026725/full_$(date +%Y%m%d_%H%M%S)"
...
```
~/b/Ckp/4dwvlaOpvlaLibplusKpt0911/.../eval_libero_plus/step_026725/
...
| 项目 | 优先级 | 说明 |
|------|--------|------|
| Phase 4: 全量评估 (keypoints 默认启用) | HIGH | GPU 释放后 (2026-09-15) 立即启动 |
| Phase 4: 对照组评估 (`DISABLE_KEYPOINTS=1`) | HIGH | 与有关键点结果做 SR 对比 |
| Phase 5: 数据分析 | MEDIUM | 分析 7 类扰动下关键点的具体提升量 |
| 集成测试: 13.8.2 冒烟测试 | MEDIUM | 需要真实 robosuite env, GPU 释放后可运行 |
