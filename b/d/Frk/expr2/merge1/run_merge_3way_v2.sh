#!/bin/bash
# Weighted merge of 3 InternVLA-A1.5 checkpoints (0.2/0.2/0.6 weights)
#
# Usage: bash run_merge_3way_v2.sh
...
OUTPUT="/home/nvidia/bt/ckp/4wvlaFrk/plug/aug1w02augtw5k02pure1w06/"

# Weights (0.2 + 0.2 + 0.6 = 1.0)
WEIGHT1=0.2  # Data augmentation, 10k steps
WEIGHT2=0.2  # Affine data augmentation, 5k steps
WEIGHT3=0.6  # No augmentation
